...
(function load() {
  ...
  for (x in students) {
    write =
      write +
      `<tr><td>${students[x].ID}</td><td>${students[x].name}</td><td>${students[x].email}</td><td>${students[x].age}</td><td>${students[x].grade}</td><td>${students[x].degree}
  ...
  for (x in students) {
    write =
      ...
      `<tr>
        ...
        <td>${students[x].age}</td>
        <td>${students[x].grade}</td>
        <td>${students[x].degree}
        <img  id="edit-btn" onclick="edit(${students[x].ID})" src="./assest/pencil-svgrepo-com.svg">
        <img onclick="deleteStudent(${students[x].ID})" src="./assest/trash-svgrepo-com.svg">
